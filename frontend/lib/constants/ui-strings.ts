...
export const UI = {
  ...
  NOTIF_NOT_CONFIGURED: 'Chưa cấu hình OneSignal trên server (NEXT_PUBLIC_ONESIGNAL_APP_ID)',
  ...
  CEREMONY_TEMPLATE_CONTENT_HINT: 'Nhập nội dung bài cúng — giữ Enter để xuống dòng. Chạm vào biến ở danh sách bên cạnh để chèn thông tin tự động (tên, ngày giỗ…); hệ thống sẽ tự điền khi in.',
  CEREMONY_TEMPLATE_HINT: 'Soạn mẫu bài cúng dùng chung. Chạm vào biến để chèn thông tin tự động như tên, ngày giỗ, dòng họ… hệ thống tự điền khi in.',
  ...
  CEREMONY_TEMPLATE_READONLY_HINT: 'Chọn người đã mất để xem và in bài cúng. Chỉ quản trị viên mới sửa được mẫu.',
  ...
  CEREMONY_PREVIEW_SAVE_FIRST: 'Hãy lưu mẫu trước để xem trước với dữ liệu thật',
  CEREMONY_PREVIEW_USES_SAVED: 'Xem trước dùng bản đã lưu của mẫu (lưu lại để cập nhật).',
