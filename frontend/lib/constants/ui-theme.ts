...
export const BT = {
  ...
  panel: 'overflow-hidden rounded-xl border border-amber-200/60 bg-white text-neutral-900',
  ...
  iconGhost:
    'grid h-10 w-10 shrink-0 place-items-center rounded-full text-amber-50 transition-colors active:bg-white/10 md:hover:bg-white/10 disabled:opacity-40',
  iconGold:
    'grid h-10 w-10 shrink-0 place-items-center rounded-full bg-amber-100 text-amber-950 transition-colors active:bg-amber-200 disabled:bg-white/10 disabled:text-amber-100/40',
  iconDanger:
    'grid h-10 w-10 shrink-0 place-items-center rounded-full bg-red-900/40 text-red-100 transition-colors active:bg-red-900/60 disabled:opacity-40',
  iconFab:
  ...
  iconFabSm:
    'grid h-11 w-11 place-items-center rounded-full border border-amber-200/60 bg-white text-amber-950 shadow-sm transition-colors active:bg-amber-50',

  /** Nút có icon + text ngắn */
  btnBase: 'inline-flex shrink-0 items-center justify-center gap-1.5 font-semibold transition-colors disabled:opacity-50',
  btnSm: 'rounded-xl px-3 py-2 text-sm',
  btnCompact: 'h-10 rounded-full px-3 text-sm',
  ...
  btnOutline: 'border border-amber-200/80 bg-white text-amber-950 active:bg-amber-50',
  btnOnDark: 'bg-white/10 text-amber-50 active:bg-white/20',

  pillOnDark: 'rounded-full bg-white/10 px-3 py-1.5 text-xs font-medium text-amber-50 active:bg-white/20',
  pillActive: 'rounded-full bg-amber-100 px-3 py-1.5 text-xs font-medium text-amber-950',
  pillIdle: 'rounded-full bg-white/10 px-3 py-1.5 text-xs font-medium text-amber-100/80 active:bg-white/20',
  ...
  donationBtn: 'border border-amber-300 bg-amber-100 text-amber-950 active:bg-amber-200',
