...
export const NOTIFICATION_STRINGS = {
  ...
  NOTIF_DEVICES_REGISTERED: (n: number) => (n <= 1 ? '1 thiết bị đang nhận push' : `${n} thiết bị đang nhận push`),
  ...
  CEREMONIES_DAYS_UNTIL: (days: number) => (days === 0 ? 'Hôm nay' : `Còn ${days} ngày`),
