...
export const EXPORT_STRINGS = {
  ...
  EXPORT_LAYER_LOCK: "Khóa vị trí",
  EXPORT_LAYER_UNLOCK: "Mở khóa vị trí",
  EXPORT_LAYER_LOCKED_HINT: "Đã khóa — không kéo được trên ảnh",
  ...
  EXPORT_TEXT_BOLD: "In đậm",
  EXPORT_TEXT_VERTICAL: "Chữ dọc",
  EXPORT_TEXT_CURVE: "Độ cong chữ",
  EXPORT_TEXT_CURVE_STRAIGHT: "thẳng",
  EXPORT_TEXT_CURVE_DECREASE: "Giảm độ cong",
  EXPORT_TEXT_CURVE_INCREASE: "Tăng độ cong",
  EXPORT_TEXT_ROTATION: "Xoay chữ",
  EXPORT_TEXT_ROTATION_NONE: "0°",
  EXPORT_TEXT_ROTATION_LEFT: "Xoay trái",
  EXPORT_TEXT_ROTATION_RIGHT: "Xoay phải",
