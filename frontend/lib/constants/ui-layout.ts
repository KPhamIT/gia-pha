...
export const LAYOUT = {
  overlay:
    'overlay-viewport z-50 flex min-h-0 flex-col overflow-hidden md:items-center md:justify-center md:p-6 lg:p-8',
  overlayBackdropDark: 'md:bg-black/55',
  overlayBackdropLight: 'md:bg-slate-900/35',
  panel:
    'flex h-full min-h-0 w-full max-w-full flex-col overflow-hidden pb-[env(safe-area-inset-bottom)] md:max-h-[min(100%,56rem)] md:h-[min(100%,56rem)] md:max-w-4xl md:flex-none md:rounded-2xl md:shadow-2xl',
  ...
  bottomSheetOverlay:
    'overlay-viewport z-50 flex items-end justify-center md:items-center md:p-6 lg:p-8 md:bg-slate-900/35',
  bottomSheetPanel:
    'relative flex max-h-[min(100dvh,100%)] w-full max-w-full min-w-0 flex-col overflow-hidden rounded-t-3xl bg-white shadow-2xl pb-[env(safe-area-inset-bottom)] md:max-h-[min(100%,40rem)] md:max-w-lg md:rounded-2xl md:pb-0',
  ...
  centeredOverlay: 'overlay-viewport z-50 flex items-center justify-center p-4 md:p-6 lg:p-8',
