...
export default function UpcomingCeremoniesPageContent() {
  ...
  if (!isLoggedIn) {
    return (
      <BookPageShell title={UI.CEREMONIES_UPCOMING_TITLE} subtitle={UI.CEREMONIES_UPCOMING_SUBTITLE}>
  ...
  const showCeremony = viewCeremony && personId != null && !Number.isNaN(personId);
