...
export function consumeBookTouchRecovery(): boolean {
  ...
  if (window.sessionStorage.getItem(BOOK_TOUCH_RECOVERY_KEY) !== '1') return false;
...
export function useAppNavigation() {
  ...
  return useMemo(
    ...
    [openAccount, openBook, openCeremonyTemplates, openEvents, openNotifications, openTree, openUsers],
  );
}
