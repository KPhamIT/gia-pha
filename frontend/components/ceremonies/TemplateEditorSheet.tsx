...
export default function TemplateEditorSheet({ target, variables, persons, relationships, onClose, onSaved }: Props) {
  const { template, form, setForm, saving, tab, setTab, contentRef, unknownCount, insertVariable, handleSave, requestClose } =
