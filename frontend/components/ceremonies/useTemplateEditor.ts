...
import { TOKEN_RE, type EditTarget, type FormState } from './ceremony-template-shared';
...
export function useTemplateEditor(
  ...
  return { template, form, setForm, saving, tab, setTab, contentRef, unknownCount, insertVariable, handleSave, requestClose };
}
