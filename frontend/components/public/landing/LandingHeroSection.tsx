...
export default function LandingHeroSection() {
  return (
    <section className="relative flex min-h-[80vh] items-center overflow-hidden bg-[#1c1c19]">
      <div
        className="absolute inset-0 bg-contain bg-bottom bg-no-repeat md:bg-cover md:bg-center"
