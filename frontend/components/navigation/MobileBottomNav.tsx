    ...
    case "notes":
      return (
        <svg viewBox="0 0 24 24" width={24} height={24} aria-hidden className={className}>
          <path
            fill="currentColor"
            d="M19 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2zm-2 12H7v-2h10v2zm0-4H7V9h10v2zm0-4H7V5h10v2z"
          />
        </svg>
      );
    case "profile":
  ...
  return (
    ...
    >
      <nav
        ...
        aria-hidden={hidden}
        className={`pointer-events-auto mx-auto flex h-14 max-w-lg items-center justify-between gap-0.5 rounded-full border border-black/5 bg-white/95 px-1 shadow-[0_4px_24px_rgba(28,28,25,0.14)] backdrop-blur-md ${
