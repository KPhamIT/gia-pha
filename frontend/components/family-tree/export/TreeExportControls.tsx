...
export default function TreeExportControls({
  ...
  return (
    <div
      className="pointer-events-none fixed inset-x-0 bottom-0 z-50 flex justify-center px-2 pb-[max(0.5rem,env(safe-area-inset-bottom))] 
    md:inset-y-0 md:right-4 md:left-auto md:items-center md:px-0 md:py-4"
    >
      <div
        className="pointer-events-auto flex max-h-[55vh] w-full max-w-md flex-col overflow-hidden rounded-2xl border border-amber-200/70 
      bg-white/92 shadow-2xl backdrop-blur-md md:max-h-[92vh] md:w-80"
      >
        <div className="flex shrink-0 items-center justify-between border-b border-amber-100 px-4 py-3">
          ...
          <div className="flex items-center gap-1">
            ...
            >
              <Icon
                path={collapsed ? "chevronUp" : "chevronDown"}
                size={16}
                fill="none"
                stroke="currentColor"
                strokeWidth={2}
          ...
          <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain px-4 py-3">
            ...
            <label className="mb-2 block">
              ...
              <input
                ...
                onChange={(e) =>
                  onPatch({ headerHeight: Number(e.target.value) })
                }
            ...
            <label className="mb-2 block">
              ...
              <input
                ...
                onChange={(e) =>
                  onPatch({ coupletFontSize: Number(e.target.value) })
                }
                className="w-full accent-amber-600"
              />
            </label>
              ...
              return (
                ...
                >
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      onPatchCouplet(key, { text: e.target.value })
                    }
            ...
            <label className="mb-2 block">
              ...
              <input
                ...
                onChange={(e) =>
                  onPatch({ nodeFontSize: Number(e.target.value) })
                }
                className="w-full accent-amber-600"
              />
            </label>
        ...
        <div className="shrink-0 border-t border-amber-100 p-3">
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl bg-amber-700 px-4 py-2.5 text-sm font-semibold text-white 
            shadow-sm transition active:bg-amber-800 disabled:opacity-50"
          >
            <Icon
              path="download"
              size={18}
