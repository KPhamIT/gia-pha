...
export default function EventDonationsView({ event, persons, onClose, onEventPatched }: Props) {
  const { draftDonations, isDirty, donationTotal, inKindCount, loading, saving, upsertDraft, removeDraft, handleSave } =
  ...
  return (
    <>
      <FullScreenSheet title={UI.EVENT_DONATION_SECTION} onClose={handleClose} headerRight={headerActions} tone="book">
