...
export default function BookStage({
  ...
  return (
    <>
      {!isPrintAllLayout ? (
        <div
          className={`${styles.stageArea} relative min-h-0 flex-1 px-3 pb-3 md:px-4 md:pb-4`}
              ...
              <div className={styles.page}>
                ...
                {flip ? (
                  <>
                    ...
                    <div
                      className={`${styles.flipLeaf} ${flip.dir === "next" ? styles.flipLeafNext : styles.flipLeafPrev}`}
                      aria-hidden
                    >
      ...
      <div
        className={styles.printSingleStack}
        aria-hidden
